...
sonarqube {
    properties {
        ...
        property("sonar.projectKey", "library::spring-kotlin-aop-logging")
        property("sonar.projectName", "spring-kotlin-aop-logging")
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("spring-kotlin-aop-logging")
                ...
                scm {
                    url.set("https://github.com/mbogner/library-spring-kotlin-aop-logging")
                    connection.set("git@github.com:mbogner/library-spring-kotlin-aop-logging.git")
                    developerConnection.set("git@github.com:mbogner/library-spring-kotlin-aop-logging.git")
                }
                developers {
                    developer {
                        id.set("mbo")
